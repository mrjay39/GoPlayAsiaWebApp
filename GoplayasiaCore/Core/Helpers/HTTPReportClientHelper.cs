...
{
    public class HTTPReportClientHelper : IHTTPReportClientHelper
    {
        ...
        public HTTPReportClientHelper(IConfiguration config)
        {
            _jsonSerializer = new JsonSerializer();
            _config = config;
            _api = config.GetValue<String>("ReportingAPI");
            if (!_api.EndsWith('/'))
                _api += '/';
            if (_client == null)
            {
